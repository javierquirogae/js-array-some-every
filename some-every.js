...
/*
Write a function called hasAZero which accepts a number and returns true if that number contains at least one zero. Otherwise, 
...
function hasCertainKey(arr, key) {
    ...
    return arr.every(function(o){
        let arrOfKeys = Object.keys(o);
        return arrOfKeys.some(function(k){
            return key === k;
        });
    });
}
